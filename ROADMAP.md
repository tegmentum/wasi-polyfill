...
|-------|-----------|--------|
| Phase 0 | `browser:types`, `browser:runtime`, `browser:console` | Planned |
| Phase 1 | `browser:fetch`, `browser:storage`, `browser:performance` | Planned |
| Phase 2 | `browser:dom`, `browser:events` | Planned |
| Phase 3 | `browser:canvas` | Planned |
